 ...
 */
export class DbTeReflectionStore {
    constructor(db) {
    ...
    async getReflections(userId, limit) {
        return this.store.getReflections(userId, limit);
    }
    async getReflectionsBySession(sessionId, limit) {
        return this.store.getReflectionsBySession(sessionId, limit);
    }
}
//# sourceMappingURL=dbReflectionStore.js.map