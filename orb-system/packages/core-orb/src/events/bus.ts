...
class InMemoryEventStore {
  ...
  query(filter: EventFilter): OrbEvent[] {
  ...
  getStats(filter?: EventFilter): EventStats {
    ...
    return {
      ...
      byMode,
      byRole: byRole as Record<OrbRole, number>,
      mostUsedModes,
...
let globalEventBus: OrbEventBus | null = null;

/**
 * Get the global event bus instance
 */
export function getEventBus(): OrbEventBus {
  if (!globalEventBus) {
