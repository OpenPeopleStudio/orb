 ...
 */
export function evaluateAction(action, context, constraintSets) {
    const triggeredConstraints = [];
    const reasons = [];
    const recommendations = [];
    let decision = 'allow';
    let effectiveRisk = action.estimatedRisk || 'low';
 ...
 */
function doesConstraintApply(constraint, context, action) {
    // Check mode scope
 ...
 */
function checkConstraintViolation(constraint, action, context) {
 ...
 */
export async function collectConstraintSets(context) {
