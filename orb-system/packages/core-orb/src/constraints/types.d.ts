 ...
 */
export type ConstraintType = 'block_action' | 'block_tool' | 'max_risk' | 'require_confirmation' | 'mode_transition' | 'persona_mismatch' | 'device_restriction' | 'time_restriction' | 'other';
/**
