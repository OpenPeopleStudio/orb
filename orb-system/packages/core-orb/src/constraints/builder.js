 ...
 */
function generateConstraintId(prefix = 'constraint') {
    return `${prefix}-${Date.now()}-${constraintIdCounter++}`;
}
/**
 * Create a constraint set
 */
export function createConstraintSet(name, constraints, options) {
    return {
 ...
 */
export function blockTool(toolId, options) {
    return {
 ...
 */
export function maxRisk(maxRisk, options) {
    return {
 ...
 */
export function requireConfirmation(description, options) {
    return {
 ...
 */
export function restrictModeTransition(allowedModes, options) {
    return {
 ...
 */
export function requirePersona(requiredPersona, options) {
    return {
 ...
 */
export function restrictToDevices(allowedDevices, options) {
    return {
 ...
 */
export function parseConstraintString(constraintStr, mode) {
